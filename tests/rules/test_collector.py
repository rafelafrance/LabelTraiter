...
from labels.pylib.rules.job import Job
...
class TestCollector(unittest.TestCase):
    ...
    def test_collector_05(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                Date(start=34, end=49, date="2002-10-20"),
            ],
        )
    ...
    def test_collector_14(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                Date(start=95, end=112, date="2016-08-11"),
            ],
        )
    ...
    def test_collector_20(self):
        self.assertEqual(
            ...
            [
                ...
                Date(start=30, end=41, date="2011-04-14"),
            ],
        )
    ...
    def test_collector_22(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                Job(start=38, end=45, job="collector", name="G. Rink"),
                IdNumber(
                    start=46,
                    end=50,
                    number="7075",
    ...
    def test_collector_27(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                Date(start=64, end=76, date="1956-07-06"),
            ],
        )
    ...
    def test_collector_31(self):
        self.assertEqual(
            ...
            [
                Job(start=0, end=9, job="collector", name="Joni Ward"),
                IdNumber(
                    start=10,
                    end=15,
                    number="866-a",
    ...
    def test_collector_38(self):
        self.assertEqual(
            ...
            [
                Date(start=0, end=16, date="2008-09-04"),
                Job(
                    start=17,
                    end=40,
                    job="collector",
    ...
    def test_collector_39(self):
        self.assertEqual(
            ...
            [
                ...
                Job(start=10, end=19, job="collector", name="H. Richey"),
            ],
        )
    ...
    def test_collector_40(self):
        self.assertEqual(
            ...
            [
                Job(start=0, end=11, job="collector", name="AC Saunders"),
                IdNumber(
                    start=12,
                    end=17,
                    number="34380",
